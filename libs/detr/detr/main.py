...
def get_args_parser():
    ...
    parser.add_argument("--plot_ft", action="store_true")
    parser.add_argument("--rotation_loss", action="store_true", default=False)
    parser.add_argument("--loss_type", action="store", type=str, default="l1",
                        help="l1 or mse")

    parser.add_argument('--bimanual', action='store_true', default=True)
...
def build_ACT_model_and_optimizer(args_override):
    ...
    args = parser.parse_known_args()[0]  # ignore unknown args
